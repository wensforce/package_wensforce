...
import { formatServiceWindow } from '@/app/utils/expo/expoUtils';
import { trackExpoDetailView } from '@/app/utils/expo/expoTracking';
import ExpoPackagesSection from '../../components/expo/ExpoPackagesSection';
import ExpoFAQ from '../../components/expo/ExpoFAQ';
import ExpoTestimonialsSection from '../../components/expo/ExpoTestimonialsSection';
import ExpoServiceCoverage from '../../components/expo/ExpoServiceCoverage';
import EventExpoGallery from '../../components/expo/EventExpoGallery';
import CountDownBadge from '../../components/expo/CountDownBadge';
import CustomQuoteSection from '../../components/expo/CustomQuoteSection';

export default function ExpoDetailClient({ expo, packages }) {
