...
import { Loader2, Share2, Layers, Gift, Clock, AlertCircle, Plus, Check, Search } from "lucide-react";
...
const sectionCardCls = "rounded-xl border border-[#CBD5E0] bg-white p-5 space-y-5 shadow-sm";
...
export default function ReferralProgramForm({
  ...
  const isEditMode = Boolean(programId || initialData);
  ...
  const handleSubmit = async (e) => {
    ...
    if (!finalCategory) {
      setFormError("Package category is required.");
      return;
    }
    ...
    try {
      ...
      const targetId = programId || initialData?.id;

      if (isEditMode && targetId) {
        await referralApi.updateProgram(targetId, payload);
      ...
      if (onSaved) {
        ...
        router.push("/admin/referral-programs");
      }
    } catch (err) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      {formError && (
        <div className="flex items-center gap-2 p-3.5 rounded-xl border border-red-200 bg-red-50 text-xs text-red-700">
      ...
      <div className={sectionCardCls}>
        <h3 className="text-xs font-bold text-[#0B1E3F] uppercase tracking-wider border-b border-[#CBD5E0] pb-2.5 flex items-center gap-1.5">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          {/* Dates */}
          <div className="space-y-1.5">
            <label className="block text-xs font-semibold text-[#0B1E3F]">Start Date & Time</label>
            <input
              type="datetime-local"
              value={startDate}
          ...
          <div className="space-y-1.5">
            <label className="block text-xs font-semibold text-[#0B1E3F]">End Date & Time</label>
            <input
              type="datetime-local"
              value={endDate}
      ...
      <div className={sectionCardCls}>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-1.5">
            <label className="block text-xs font-semibold text-[#0B1E3F]">
              Max Redemptions Per Referrer (Blank = Unlimited)
            </label>
            <input
              type="number"
              min="0"
      ...
      <div className={sectionCardCls}>
        ...
        <div className="space-y-3">
          <label className="block text-xs font-semibold text-[#0B1E3F]">
            When should rewards be issued to Referrer & Referee?
          </label>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              ...
              <p className="text-[10px] opacity-75 mt-1 font-normal">
                Issued instantly when referee applies referral code on registration.
              </p>
            </button>
          ...
          <div className="space-y-2 pt-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 max-h-36 overflow-y-auto p-2.5 border border-[#CBD5E0] rounded-xl bg-[#FAF6EC]">
                ...
                triggerPackageSearch.filteredPackages.map((pkg) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-2.5 py-1.5 rounded-lg text-xs font-medium text-left border flex items-center justify-between transition-colors ${
                        selected
      ...
      <div className={sectionCardCls}>
            ...
            <>
              ...
              <div className="space-y-1.5">
                ...
                <input
                  type="number"
                  min="0"
                  max={referrerRewardCalcType === "percentage" ? 100 : undefined}
                  step="any"
        ...
        {referrerRewardType !== "none" && (
          <div className="space-y-2 pt-2 border-t border-[#CBD5E0]">
            ...
            {referrerPackageScope === "custom" && (
              <div className="space-y-1.5 mt-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 max-h-32 overflow-y-auto p-2.5 border border-[#CBD5E0] rounded-xl bg-[#FAF6EC]">
                    ...
                    referrerPackageSearch.filteredPackages.map((pkg) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-2 py-1 rounded text-xs font-medium text-left border flex items-center justify-between transition-colors ${
                            selected
                              ? "bg-[#0B1E3F] text-white border-[#0B1E3F]"
            ...
            <>
              ...
              <div className="space-y-1.5">
                ...
                <input
                  type="number"
                  min="0"
                  max={refereeRewardCalcType === "percentage" ? 100 : undefined}
                  step="any"
