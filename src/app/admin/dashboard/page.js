  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[70vh] gap-3">
        ...
        <p className="text-[#0B1E3F] font-medium text-sm animate-pulse">
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[70vh] p-6 text-center">
        ...
        <h3 className="text-lg font-semibold text-[#0B1E3F] mb-2">
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-500">
              Monthly revenue compared with order frequency.
            </p>
          </div>
          <div className="h-80">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm flex flex-col">
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-500">
              Distribution of subscriptions by active status.
            </p>
          </div>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
          <div className="mb-4">
            <h3 className="text-base font-bold text-[#0B1E3F]">
              Trips & Bookings Breakdown
            </h3>
            <p className="text-xs text-gray-500">
              Aggregated status of requested bookings and logistics.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-3">
              <span className="text-xs font-bold text-[#0B1E3F] block uppercase tracking-wider border-b pb-1">
                Trips ({tripStatusData.reduce((a, b) => a + b.count, 0)})
              </span>
            ...
            <div className="space-y-3">
              <span className="text-xs font-bold text-[#0B1E3F] block uppercase tracking-wider border-b pb-1">
                Bookings ({bookingStatusData.reduce((a, b) => a + b.count, 0)})
              </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm flex flex-col">
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-500">
              Top packages sorted by active subscription counts.
            </p>
          </div>
                  ...
                  <div key={pkg.name} className="space-y-1">
                    <div className="flex items-center justify-between text-xs font-semibold">
                      <div className="flex items-center gap-2">
                        <span className="text-[#C9A24B] font-bold">
                          #{idx + 1}
                        </span>
                        <span className="text-[#0B1E3F]">{pkg.name}</span>
                      </div>
                      <span className="text-gray-500 font-bold">
                        {pkg.subscriptions} subs
                      </span>
                    </div>
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm flex flex-col">
          <div className="mb-4">
            ...
            <p className="text-xs text-gray-500">
              Most active coupon codes and redemption count.
            </p>
          </div>
      ...
      <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            This dashboard aggregates verified entries. Non-activated
            subscriptions and unpaid orders are excluded from totals.
          </p>
        </div>
        <div className="flex gap-4">
          <div className="text-center bg-gray-50 px-4 py-2 rounded-lg border border-gray-100">
            <span className="block text-xs font-bold text-[#0B1E3F]">
              {stats.totalPackages}
            </span>
