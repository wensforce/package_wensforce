...
import { Check, XCircle, Loader2, ArrowLeft, Gem, Crown, Shield } from 'lucide-react';

const WA_NUMBER = '917304607954';

const PLAN_IMAGES = {
  essential: 'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?auto=format&fit=crop&w=1200&q=80',
  executive: 'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fit=crop&w=1200&q=80',
  premium:   'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&w=1200&q=80',
  elite:     'https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=1200&q=80',
  sovereign: 'https://images.unsplash.com/photo-1494976388531-d1058494cdd8?auto=format&fit=crop&w=1200&q=80',
};

// ── Loading Screen ────────────────────────────────────────────────────────────
function LoadingScreen() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-6" style={{ backgroundColor: '#0B1E3F' }}>
      <div
        className="fixed top-1/3 left-1/2 -translate-x-1/2 w-[500px] h-[300px] rounded-full blur-[100px] pointer-events-none"
        style={{ background: 'radial-gradient(ellipse, rgba(201,162,75,0.12) 0%, transparent 70%)' }}
      />
    ...
    return (
      <div className="min-h-screen" style={{ backgroundColor: '#0B1E3F' }}>
        ...
        <div
          ...
          style={{
            backgroundImage: 'radial-gradient(circle at 1px 1px, rgba(201,162,75,0.05) 1px, transparent 0)',
            backgroundSize: '38px 38px',
          }}
        />
        <div
          className="fixed top-0 left-1/2 -translate-x-1/2 w-[700px] h-[400px] pointer-events-none"
          style={{ background: 'radial-gradient(ellipse at top, rgba(201,162,75,0.12) 0%, transparent 65%)' }}
        />
          ...
          <div className="max-w-lg w-full">
            ...
            <div
              ...
              style={{
                ...
                boxShadow: '0 32px 80px rgba(0,0,0,0.35), 0 0 0 1px rgba(201,162,75,0.06)',
              }}
            >
              {/* Gold accent line */}
              ...
              <div className="relative overflow-hidden" style={{ height: 140 }}>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: '0 0 0 6px rgba(201,162,75,0.2), 0 12px 32px rgba(201,162,75,0.5)',
                    }}
                  >
                ...
                <div className="absolute top-4 right-4">
                  <span
                    ...
                    style={{ background: 'rgba(201,162,75,0.25)', color: '#C9A24B', border: '1px solid rgba(201,162,75,0.3)' }}
                  >
                    Payment Confirmed
                  </span>
                </div>
              ...
              <div className="px-7 py-6">
                ...
                <h1 className="font-serif-display text-2xl sm:text-3xl font-bold text-gray-900 mb-4 leading-tight">
                  Your{' '}
                  <span style={{ color: '#C9A24B' }}>{planLabel}</span>{' '}
                  Membership<br />is now active.
                </h1>
                ...
                {orderId && (
                  <div
                    ...
                    style={{ backgroundColor: '#fafaf8', border: '1px solid rgba(201,162,75,0.1)' }}
                  >
                      ...
                      <div key={i} className="flex gap-4 relative">
                        ...
                        <div className="flex flex-col items-center">
                          <div
                            ...
                            style={{
                              borderColor: s.done ? '#C9A24B' : 'rgba(0,0,0,0.12)',
                        ...
                        {/* Right: text */}
                        <div className="pb-5">
                          <p className={`text-sm font-semibold ${s.done ? 'text-gray-900' : 'text-gray-500'}`}>
                            {s.label}
                          </p>
                          <p className="text-xs text-gray-400 font-light mt-0.5">{s.sub}</p>
                        </div>
                      </div>
                    ))}
                  </div>
          ...
          >
            ...
            <div className="px-7 py-10 text-center">
              ...
              <div
                ...
                style={{ backgroundColor: 'rgba(239,68,68,0.08)', border: '2px solid rgba(239,68,68,0.2)' }}
              >
