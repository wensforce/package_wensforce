        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-white/65 text-[15px] leading-relaxed font-light">
              <p>
                After years arranging mobility for global executives and
                dignitaries, I noticed a gap. India&apos;s most discerning
                travellers — business families, NRIs, C-suite leaders,
                celebrities — were patching together services from six different
                vendors for a single trip.
              </p>
              <p>
                Vehicle from one. Bodyguard from another. VIP Darshan from a
                third. None of them spoke to each other. Service was
                inconsistent. Trust was uncertain.
              </p>
              <p>
                WENS Force is what I would have built if I were the customer.
                One subscription. One concierge. One annual fee. Everything
                pre-arranged. Quality I would put my own name on.
              </p>
            </div>

            <div className="mt-8 pt-6 border-t border-white/10">
              <p className="text-white font-semibold text-sm">
                — Founder & CEO, WENS Force
              </p>
              <a
