        ...
        {!started ? (
          ...
          <div className="text-center">
            ...
            <p className="text-gray-500 text-base font-light mb-8 max-w-sm mx-auto">
              Answer 5 quick questions and we&apos;ll recommend the perfect
              membership for your lifestyle — and send the brochure to your
              WhatsApp.
            </p>
            <button
              onClick={() => setStarted(true)}
              className="inline-flex cursor-pointer items-center gap-2 px-8 py-4 rounded-full font-semibold text-white text-sm transition-all hover:opacity-90 hover:shadow-lg active:scale-95"
          ...
          <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-xl border border-gray-100 quiz-in">
            ...
            <div className="w-full aspect-[2/1] mb-6 rounded-xl overflow-hidden border border-gray-100 bg-white shadow-sm">
              <img
                src={`/cards/${
                  recommended.id === "essential"
                    ? "Sedan_Essential_Desktop.png"
                    : recommended.id === "executive"
                      ? "BMW_Executive_v2.png"
                      : recommended.id === "premium"
                        ? "GLC_Premium_v2.png"
                        : recommended.id === "elite"
                          ? "S-Class_Elite_v2.jpg"
                          : recommended.id === "sovereign"
                            ? "Defender_Sovereign_v2.png"
                            : "Sedan_Essential_Desktop.png"
                }`}
