...
export default function ExpoHeroSlider() {
  ...
  return (
    <>
      <style>{`
        .hero-slider { position: relative; width: 100%; max-width: 100%; overflow: hidden; }
        
        .swiper-hero { width: 100%; max-width: 100%; }
