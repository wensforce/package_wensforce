...
export default function ExpoServiceCoverage({ expo }) {
  const airport = expo.airport || {
    code: expo.airportCode ?? 'N/A',
    name: expo.airportName ?? 'Airport information',
    distance: expo.airportDistance,
    travelTime: expo.airportTravelTime,
  };

  const distanceLabel = formatAirportDistanceKm(
    airport.distance ?? expo.airportDistance,
  );
  const travelTimeLabel = formatAirportTravelHours(
    airport.travelTime ?? expo.airportTravelTime,
  );
        ...
        <div className="airport-section">
          <div className="airport-header">
            ...
            <div className="airport-item">
              ...
              <span className="airport-value">{distanceLabel}</span>
            ...
            <div className="airport-item airport-item-last">
              ...
              <span className="airport-value">{travelTimeLabel}</span>
