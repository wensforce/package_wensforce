...
const CARDS = [
  {
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-11 h-11">
        <path d="M24 4L28.5 14.5H40L30.75 21L34.5 32L24 25.5L13.5 32L17.25 21L8 14.5H19.5L24 4Z" stroke="#C9A24B" strokeWidth="2" strokeLinejoin="round"/>
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-11 h-11">
        <rect x="10" y="16" width="28" height="22" rx="3" stroke="#C9A24B" strokeWidth="2"/>
        <path d="M24 8v8M17 12l4 4M31 12l-4 4" stroke="#C9A24B" strokeWidth="2" strokeLinecap="round"/>
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-11 h-11">
        <rect x="6" y="22" width="36" height="14" rx="7" stroke="#C9A24B" strokeWidth="2"/>
        <circle cx="14" cy="36" r="4" stroke="#C9A24B" strokeWidth="2"/>
        <circle cx="34" cy="36" r="4" stroke="#C9A24B" strokeWidth="2"/>
        <path d="M20 22V18a4 4 0 018 0v4" stroke="#C9A24B" strokeWidth="2" strokeLinecap="round"/>
      </svg>
    ),
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-white/40 text-sm mt-3 max-w-md mx-auto font-light">
            Blacklane has chauffeurs. Wheely has chauffeurs. Uber Black has chauffeurs. Nobody else has this combination.
          </p>
        </div>
